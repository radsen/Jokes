 ...
 * on 2017-06-11 at 20:39:07 UTC 
 * Modify at your own risk.
 */

package com.udacity.radsen.jokes.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "jokes".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link Jokes#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public Jokes jokes() throws java.io.IOException {
    Jokes result = new Jokes();
    initialize(result);
    return result;
  }

  public class Jokes extends MyApiRequest<com.udacity.radsen.jokes.backend.myApi.model.MyBean> {
     ...
     * parameters, call the {@link Jokes#execute()} method to invoke the remote operation. <p> {@link
     * Jokes#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)} must
     * be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected Jokes() {
      super(MyApi.this, "GET", REST_PATH, null, com.udacity.radsen.jokes.backend.myApi.model.MyBean.class);
    }
    ...
    @Override
    public Jokes setAlt(java.lang.String alt) {
      return (Jokes) super.setAlt(alt);
    }

    @Override
    public Jokes setFields(java.lang.String fields) {
      return (Jokes) super.setFields(fields);
    }

    @Override
    public Jokes setKey(java.lang.String key) {
      return (Jokes) super.setKey(key);
    }

    @Override
    public Jokes setOauthToken(java.lang.String oauthToken) {
      return (Jokes) super.setOauthToken(oauthToken);
    }

    @Override
    public Jokes setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (Jokes) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public Jokes setQuotaUser(java.lang.String quotaUser) {
      return (Jokes) super.setQuotaUser(quotaUser);
    }

    @Override
    public Jokes setUserIp(java.lang.String userIp) {
      return (Jokes) super.setUserIp(userIp);
    }

    @Override
    public Jokes set(String parameterName, Object value) {
      return (Jokes) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.udacity.radsen.jokes.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.udacity.radsen.jokes.backend.myApi.model.MyBean.class);
